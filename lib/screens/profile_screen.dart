          ...
          children: [
                  ...
                  ElevatedButton(
                      onPressed: () {
                        if (_formKey.currentState!.validate()) {
                          ...
                          ApIs.changeNamAbout();
                          Dialogs.showSnackBarForProfileScreen(
                      ...
                      style: ButtonStyle(
                          backgroundColor: MaterialStatePropertyAll(
                              Color.fromARGB(255, 54, 59, 182)),
                          shape: MaterialStatePropertyAll(
                              RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(25))),
                          minimumSize:
                              MaterialStatePropertyAll(Size(140, 55)))),
                ],
              ),
            ),
            ...
            Padding(
              padding: EdgeInsets.only(
                  bottom: mq.height * .03, left: mq.height * .2),
              child: SizedBox(
    ...
    showModalBottomSheet(
        ...
        builder: (_) {
          return ListView(
            shrinkWrap: true,
            padding:
                EdgeInsets.only(top: mq.height * .015, bottom: mq.height * .1),
            children: [
              Text(
                  ...
                  ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        if (image != null) {
                          ...
                          ApIs.updateProfilePicture(File(_image!));
                          Dialogs.showSnackBarPictureUpdateSuccessful(
